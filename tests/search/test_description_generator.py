...
async def test_generate_description_calls_haiku() -> None:
    ...
    with patch("archon_search.description_generator.ClaudeSDKClient", return_value=mock_client) as MockSDK:
...
async def test_generate_description_timeout_returns_none() -> None:
    ...
    with patch("archon_search.description_generator.ClaudeSDKClient", return_value=mock_client):
        with patch("archon_search.description_generator._TIMEOUT_SECONDS", 0.01):
...
async def test_generate_description_returns_none_on_empty_chunks() -> None:
    ...
    with patch("archon_search.description_generator.ClaudeSDKClient") as MockSDK:
...
async def test_max_buffer_size_set_on_description_generator() -> None:
    ...
    with (
        patch("archon_search.description_generator.ClaudeSDKClient", return_value=mock_client),
        patch(
            "archon_search.description_generator.ClaudeAgentOptions",
