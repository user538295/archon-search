...
async def test_mcp_ingest_file_accepts_legitimate_absolute_path() -> None:
    ...
    assert isinstance(result, dict)
    assert result == {"doc_id": "doc1", "chunks_created": 3, "status": "ok", "error": None, "warnings": [], "code": None}
...
async def test_mcp_ingest_directory_accepts_legitimate_absolute_path() -> None:
    ...
    assert result == [{"doc_id": "d", "chunks_created": 1, "status": "ok", "error": None, "warnings": [], "code": None}]
