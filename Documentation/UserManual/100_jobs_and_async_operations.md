...
Output columns: `ID` (first 8 chars), `TYPE`, `COLLECTION`, `STATUS`, `STARTED`, `ELAPSED`. When more jobs exist than were returned, it prints `Showing N of M jobs — use --limit to see more (max: 200).`
