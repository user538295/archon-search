...
**Done when**
- [x] `09_multi_instance_setup.md` covers prod install on macOS + Linux, dev-UAT Docker start, and isolation verification — S1, S2, S3, S4
- [x] `.env.example` contains the real registry path and version-pinning example — C3 (partial)
- [x] API key isolation section and HTTP/MCP client config section written — S5, S6
- [x] fastembed cache section and `archon-test` going-further note written — S10, S11
- [x] Doc index and cross-links updated — S11
...
- [x] `Documentation/Completed/multi-instance-setup-brief.md` — no changes needed (source brief)
- [x] `Documentation/Completed/multi-instance-setup-team-plan.md` — this file
- [x] `Documentation/UserManual/09_multi_instance_setup.md` — **new file** (primary deliverable)
- [x] `.env.example` — update with real registry path + version-pinning example
- [x] `Documentation/Architecture/990_documentation_index_and_contribution_guide.md` — add entry for the new manual file
- [x] `Documentation/UserManual/03_running_the_server.md` — add cross-link to `09_multi_instance_setup.md`
- [x] `Documentation/UserManual/08_running_with_docker.md` — add cross-link to `09_multi_instance_setup.md`
- [x] `CLAUDE.md` — no changes needed (`Documentation/UserManual/` is already in the documentation map)
