...
**ID**: S232-stamp_file_present_and_nonempty
**Scenario**: S232
**Severity**: medium
**Version**: archon-search, version 26.8.1848

### What happened
AssertionError: cat /pip-packages/.extras-installed exited 1: Error response from daemon: {"message":"No such container: archon-recreate"}
...
### Evidence
```
E   AssertionError: cat /pip-packages/.extras-installed exited 1: Error response from daemon: {"message":"No such container: archon-recreate"}
E     
E   assert 1 == 0
E    +  where 1 = CompletedProcess(args=['docker', 'exec', 'archon-recreate', 'cat', '/pip-packages/.extras-installed'], returncode=1, stdout='', stderr='Error response from daemon: {"message":"No such container: archon-recreate"}
').returncode
```
