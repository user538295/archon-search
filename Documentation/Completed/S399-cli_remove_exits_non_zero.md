...
**ID**: S399-cli_remove_exits_non_zero
**Scenario**: S399
**Severity**: medium
**Version**: archon-search, version 26.8.1848

### What happened
AssertionError: `collection remove archon_s399_docs` exited 0 while the collection's ingest job was still writing; UserManual/50_ingestion_and_collections.md:124 documents a 503 refusal
stdout: Removed collection 'archon_s399_docs'.
...
### Evidence
```
E   AssertionError: `collection remove archon_s399_docs` exited 0 while the collection's ingest job was still writing; UserManual/50_ingestion_and_collections.md:124 documents a 503 refusal
E     stdout: Removed collection 'archon_s399_docs'.
E     
E     stderr: 
E   assert 0 != 0
E    +  where 0 = CompletedProcess(args=('archon-search', 'collection', 'remove', 'archon_s399_docs'), returncode=0, stdout="Removed collection 'archon_s399_docs'.
", stderr='').returncode
```
