...
**ID**: S232-second_start_healthy_within_60s
**Scenario**: S232
**Severity**: medium
**Version**: archon-search, version 26.8.1848

### What happened
AssertionError: second start did not reach /health 200 within 60s (stamp should skip re-install)
assert False
...
### Evidence
```
E   AssertionError: second start did not reach /health 200 within 60s (stamp should skip re-install)
E   assert False
```
