...
**Last reviewed**: 2026-07-29 / all E2f–E2j confirmed shipped; no further review scheduled
...
"Before" = state at 2026-07-03 baseline. "Now" = shipped state after E2b–E2e (2026-07-06). "After" = actual shipped state (E2f–E2j also shipped 2026-07-12).

| # | Capability (bar-setter) | Before | Now (E2b–E2e ✓) | After (E2f–E2j ✓) | Driven by |
|---|---|---|---|---|---|
...
- All scores are actuals (code verified); E2f–E2j shipped 2026-07-12.
- **#2, #3, #4, #5, #6 improved** — E2f/E2g/E2h/E2i shipped typed relations, entity resolution, community summarization, PPR, and PageRank salience.
