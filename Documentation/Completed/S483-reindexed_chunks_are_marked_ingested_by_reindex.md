...
### What happened
AssertionError: chunks report ingested_by=['cli'], expected ['reindex'] — 55_chunk_metadata_and_enrichment.md:28 lists `reindex` as the call site a reindexed chunk carries, and the automatic chunk-size rebuild (50_ingestion_and_collections.md:181) is a reindex.
...
### Evidence
```
E   AssertionError: chunks report ingested_by=['cli'], expected ['reindex'] — 55_chunk_metadata_and_enrichment.md:28 lists `reindex` as the call site a reindexed chunk carries, and the automatic chunk-size rebuild (50_ingestion_and_collections.md:181) is a reindex.
...
E     
E   assert ['cli'] == ['reindex']
E     
E     At index 0 diff: 'cli' != 'reindex'
