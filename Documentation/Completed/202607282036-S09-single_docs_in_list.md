...
**ID**: 202607282036-S09-single_docs_in_list
**Scenario**: S09
**Severity**: medium
...
' = <built-in method lower of str object at 0x10b2d9f20>()
E    +    where <built-in method lower of str object at 0x10b2d9f20> = ('archon_test_docs  docs=0  chunks=3
' + '').lower
E    +      where 'archon_test_docs  docs=0  chunks=3
