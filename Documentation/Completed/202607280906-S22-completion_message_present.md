...
**ID**: 202607280906-S22-completion_message_present
**Scenario**: S22
**Severity**: medium
...
E     
E   assert False
E    +  where False = any(<generator object TestS22Reindex.test_completion_message_present.<locals>.<genexpr> at 0x106ecbbc0>)
```
