...
**ID**: S40-search_result_references_doc
**Scenario**: S40
**Severity**: medium
**Version**: archon-search, version 26.8.1800

### What happened
AssertionError: Expected 'doc.md' in result sources; got: []
assert False
...
### Evidence
```
E   AssertionError: Expected 'doc.md' in result sources; got: []
E   assert False
E    +  where False = any(<generator object TestS40DockerSmoke.test_search_result_references_doc.<locals>.<genexpr> at 0x10ba5b920>)
```
