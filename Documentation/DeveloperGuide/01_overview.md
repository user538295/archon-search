...
| Schema validation on response | Pydantic (`response_model=`) | Pydantic (`mcp_schemas.py`) — all 11 tools validate through `extra='forbid'` schemas before serialization (C7; debt item `API-4` resolved) |
