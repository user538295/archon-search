...
**ID**: S30-search_has_results
**Scenario**: S30
**Severity**: medium
**Version**: archon-search, version 26.8.1800

### What happened
AssertionError: Expected results, got: {'detail': 'collection not found'}
assert 0 > 0
...
### Evidence
```
E   AssertionError: Expected results, got: {'detail': 'collection not found'}
E   assert 0 > 0
E    +  where 0 = len([])
```
