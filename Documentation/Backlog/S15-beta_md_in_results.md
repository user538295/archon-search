...
**ID**: S15-beta_md_in_results
**Scenario**: S15
**Severity**: medium
**Version**: archon-search, version 26.8.1800

### What happened
AssertionError: Expected 'beta.md' in result sources; got: []
assert False
...
### Evidence
```
E   AssertionError: Expected 'beta.md' in result sources; got: []
E   assert False
E    +  where False = any(<generator object TestS15BasicSearch.test_beta_md_in_results.<locals>.<genexpr> at 0x107b6bac0>)
```
