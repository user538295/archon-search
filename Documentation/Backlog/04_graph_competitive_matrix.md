...
| Code retrieval A/B lane (RepoBench-R) | CodeRAG-Bench | ❌ | ✅ | E2e |
...
| # | Capability (bar-setter) | Before | After | Delta | Driven by |
|---|---|---|---|---|---|
| 1 | Cheap deterministic ingest (LazyGraphRAG) | **10** | **10** | — | E1a ✓ |
| 2 | Typed relations / extraction quality (MS GraphRAG) | 2 | 7 | +5 | E2g, E2i |
| 3 | Entity resolution (Graphiti/Cognee) | 2 | 7 | +5 | E2f |
| 4 | Community summarization (MS GraphRAG) | 3 | 8 | +5 | E2i |
| 5 | Query-mode breadth (MS/LightRAG) | 6 | 8 | +2 | E2h |
| 6 | Multi-hop accuracy (HippoRAG-2/KAG) | 3 | 7 | +4 | E2h + E2f + E2g |
| 7 | Freshness / incremental (Graphiti/codegraph) | 3 | 9 | +6 | E2d |
| 8 | Graph storage scale (Neo4j) | 4 | 5 | +1 | E2b truncation + lance-graph spike |
| 9 | Inspection / provenance / viz (Neo4j Bloom) | 4 | 9 | +5 | E2b, E2j, E1c ✓ |
| 10 | MCP / agent integration (Graphiti) | 8 | 9 | +1 | E2b, E2g |
| 11 | Reproducible evals (GraphRAG-Bench) | 1 | 8 | +7 | E2e |
| 12 | Local-first ops (unoccupied) | **10** | **10** | — | ✓ |
| | **Overall (mean)** | **4.7** | **8.1** | **+3.4** | |

### Caveats on the "after" column

- Assumes E2b–E2j all land as specced with E2e gates green; scores are planning estimates, not measurements.
