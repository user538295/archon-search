...
**ID**: S40-search_has_results
**Scenario**: S40
**Severity**: medium
**Version**: archon-search, version 26.8.1800

### What happened
AssertionError: Expected search results, got: {'detail': 'collection not found'}
assert 0 > 0
...
### Evidence
```
E   AssertionError: Expected search results, got: {'detail': 'collection not found'}
E   assert 0 > 0
E    +  where 0 = len([])
```
