...
- **[2026-09-05] (×3) brief refinement**: grep every "reuse X from brief Y" claim — 030 shipped a spaCy-WHEEL downloader, no checksum. Deleting a feature strands wire fields added only for it (`provider_notes`); a sibling method may keep its protocol.
